...
public class ObjectFactory {
    ...
    private final static QName _GetHelloResponse_QNAME = new QName("http://offcn.com/", "getHelloResponse");
    private final static QName _GetHello_QNAME = new QName("http://offcn.com/", "getHello");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://offcn.com/", name = "getHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://offcn.com/", name = "getHello")
